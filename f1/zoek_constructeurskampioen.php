...
if(isset($_POST['verzenden']))
{
          ...
          $query=$db->prepare("SELECT * FROM constructeurskampioen where constructeurskampioen_id like '%".$_POST['zoek']."%'order by 1");
    	   $query->execute();
 ...
 $result= $query->fetchAll(PDO::FETCH_ASSOC);
   ...
   { echo " <tr><th>Constructeurskampioen id</th>    <th>Team id</th> </tr>";
...
<label>Vul een (deel van) een constructeurskampioen id in :</label>
